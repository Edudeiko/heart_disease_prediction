...
navbar = dbc.NavbarSimple(
    brand='HEART DISEASE PREDICTION',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Ed Dudeiko', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:evgeniy.dudeyko@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/Edudeiko'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/ed-dudeiko-06384a195/'), 
